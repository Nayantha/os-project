...
_display_hardware_info:
	...
	call _show_Processor_Details		;show CPU Brand
...
;*****************get no. of hardware drives available***************
_show_HDD_info:
...
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to teX OS...Enter 'menu' to dispaly menu", 0x00
	strPrompt		db	"teX OS =>", 0x00
	...
	strHelp3			db	"enter 'hwinfo' => Display hardware information", 0x00
